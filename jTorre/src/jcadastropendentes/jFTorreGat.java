 ...
 * @author lcbenfic
 */
public class jFTorreGat extends javax.swing.JDialog {

    /**
     * Creates new form jFTorreGat
     */
    public jFTorreGat() {
        initComponents();
    ...
    private void initComponents() {
        ...
        nomeTorreGatjTextField = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        jScrollPane2 = new javax.swing.JScrollPane();
        observacaojTextArea = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        setTitle("Cadastro de Torre Gat");
        setResizable(false);
        ...
        gradeTorregatjTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gradeTorregatjTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(gradeTorregatjTable);
        gradeTorregatjTable.getColumnModel().getColumn(0).setResizable(false);
        gradeTorregatjTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeTorregatjTable.getColumnModel().getColumn(1).setResizable(false);
        gradeTorregatjTable.getColumnModel().getColumn(1).setPreferredWidth(300);
        ...
        jLabel1.setText("Nome Torre Gat");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nomeTorreGatjTextField)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(nomeTorreGatjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Cadastro Torre Gat", jPanel3);
    ...
    int recebe_codigo_credenciado;
    
    int codigo_click_torre_gat;
    ...
    public void getGradeTorresGat() throws ParseException{
       //Consultar Pessoas
        ...
        String[] colunasTabela = new String[]{"Id#", "Torre Gat"};
...
try {
            oTorresGat.setCodigo_credenciado(recebe_codigo_credenciado);
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                    Funcoes.getCodigoFormat(resultSet.getInt("CODIGO_TORRE_GAT")),
    ...
    public void getFieldTorresGat(int codigo_click_torre_gat) throws ParseException{
        //Buscar contato
        TorresGat oTorresGat = new TorresGat();
        ResultSet rs = null;
        oTorresGat.setCodigo_torre_gat(codigo_click_torre_gat);

        try {
            rs = oTorresGat.getConsultar(conecta);
            rs.next();

            //Pegar campos
            nomeTorreGatjTextField.setText(rs.getString("NOME_TORRE_GAT"));
            observacaojTextArea.setText(rs.getString("OBSERVACAO"));
            
        } catch (SQLException ex) {
            Logger.getLogger(TorresGat.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void novojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novojButtonActionPerformed
        ...
        excluirjButton.setEnabled(false);
        nomeTorreGatjTextField.grabFocus();
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        ...
        if(nomeTorreGatjTextField.getText().equals("")){
         JOptionPane.showMessageDialog(null, "O campo \"NOME TORRE GAT\" é obrigatório", "Mensagem do sistema", JOptionPane.WARNING_MESSAGE);   
            ...
            try {
                ...
                oTorresGat.setNome_torre_gat(nomeTorreGatjTextField.getText().trim().toUpperCase());
                oTorresGat.setObservacao(observacaojTextArea.getText());
                oTorresGat.setCadastrar();
            } catch (Exception e) {
    ...
    private void gradeTorregatjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gradeTorregatjTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setEnabled(true);
        
        codigo_click_torre_gat = Integer.parseInt(gradeTorregatjTable.getValueAt(gradeTorregatjTable.getSelectedRow(), 0).toString());
        try {
            getFieldTorresGat(codigo_click_torre_gat);
        } catch (ParseException ex) {
            Logger.getLogger(TorresGat.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_gradeTorregatjTableMouseClicked
    ...
    private void limparjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_limparjButtonActionPerformed
        // TODO add your handling code here:
        nomeTorreGatjTextField.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFTorreGat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new jFTorreGat().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField nomeTorreGatjTextField;
