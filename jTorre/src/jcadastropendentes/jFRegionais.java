 ...
 * @author lcbenfic
 */
public class jFRegionais extends javax.swing.JDialog {

    /**
     * Creates new form jFRegionais
     */
    public jFRegionais() {
        initComponents();
    ...
    private void initComponents() {
        ...
        gradeRegionaljTable = new javax.swing.JTable();
        jTabbedPane1 = new javax.swing.JTabbedPane();
        jPanel3 = new javax.swing.JPanel();
        jLabel1 = new javax.swing.JLabel();
        regionaljTextField = new javax.swing.JTextField();
        ...
        gradeRegionaljTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        gradeRegionaljTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gradeRegionaljTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(gradeRegionaljTable);
        gradeRegionaljTable.getColumnModel().getColumn(0).setResizable(false);
        gradeRegionaljTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeRegionaljTable.getColumnModel().getColumn(1).setResizable(false);
        gradeRegionaljTable.getColumnModel().getColumn(1).setPreferredWidth(200);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(regionaljTextField))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(regionaljTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(14, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("Cadastra regional", jPanel3);
    ...
    int codigo_regional;    
     ...
     public void getGradeRegionais() throws ParseException{
       //Consultar Regionais
        Regionais oRegionais = new Regionais();

        ResultSet resultSet = null;

        String[] colunasTabela = new String[]{"Id#", "Regional"};
        ...
        gradeRegionaljTable.setModel(modeloTabela);
        gradeRegionaljTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeRegionaljTable.getColumnModel().getColumn(1).setPreferredWidth(200);

try {
            resultSet = oRegionais.getConsultar(conecta);
            ...
            Logger.getLogger(Regionais.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                    Funcoes.getCodigoFormat(resultSet.getInt("CODIGO_REGIONAL")),
     ...
     public void getFieldRegionais(int codigo_regional) throws ParseException{
        //Buscar contato
        Regionais oRegionais = new Regionais();
        ResultSet rs = null;
        oRegionais.setCodigo_regional(codigo_regional);

        try {
            rs = oRegionais.getConsultar(conecta);
            rs.next();

            //Pegar campos           
            regionaljTextField.setText(rs.getString("REGIONAL"));
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        ...
        if(regionaljTextField.getText().equals("")){
            
            JOptionPane.showMessageDialog(null, "O campo Regional é obrigatório!", "Aten~]ao, mensagem do sistema", JOptionPane.WARNING_MESSAGE);
        }else{
            ...
            try {
                ...
                oRegionais.setRegional(regionaljTextField.getText().trim().toUpperCase());
                oRegionais.setCadastrar();
            } catch (Exception e) {
    ...
    private void gradeRegionaljTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gradeRegionaljTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setEnabled(true);
        
        codigo_regional = Integer.parseInt(gradeRegionaljTable.getValueAt(gradeRegionaljTable.getSelectedRow(), 0).toString());
        try {
            getFieldRegionais(codigo_regional);
        } catch (ParseException ex) {
            Logger.getLogger(Regionais.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_gradeRegionaljTableMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFRegionais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new jFRegionais().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable gradeRegionaljTable;
    ...
    private javax.swing.JTextField regionaljTextField;
